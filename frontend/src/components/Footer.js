  ...
  return (
    <footer className="bg-light text-center text-small py-3">
      <div className="container-fluid">
          ...
          <p className="mb-1">
          <a href="https://trevorshumway.com" target="_blank">
            Trevor Shumway &copy; 2025 </a> |{" "}
            <a href="tel:801-472-6602">801-472-6602</a> |{" "}
            <a href="mailto:trevshum20@gmail.com">trevshum20@gmail.com</a>
          </p>
        <div>
          <a
